...
def update_screen(settings, screen, stats, sb, ship, aliens, bullets, bunkers, lasers, play_button):
...
def update_bullets(settings, screen, stats, sb, ship, aliens, bullets, lasers):
    bullets.update()
    lasers.update()
