...
def run_game():
    ...
    while True:
        ...
        if stats.game_active:
            ship.update()
            gf.update_bullets(settings, screen, stats, sb, ship, aliens, bullets, lasers, mystery)
            gf.update_aliens(settings, stats, screen, sb, ship, aliens, bullets, lasers)

        gf.update_screen(settings, screen, stats, sb, ship, aliens, bullets, bunkers, lasers, play_button, mystery)
